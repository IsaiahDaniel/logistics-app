...
import { NIGERIA_STATES } from '../../../constants/data';
import Button from '../../../components/UI/Button/Button';

type Props = {}

const ShippingInterState = (props: Props) => {
  ...
  return (
   ...
   <main className="mt-10">
        ...
        <h2 className="text-2xl mb-3">Calulate Inter State Shipping Cost</h2>
        <Card classNames="p-5 py-10">
          ...
          >
            ...
            {NIGERIA_STATES.map((c) => (
              <option value={c.state}>{c.state}</option>
            ))}
          </select>
...
export default ShippingInterState;